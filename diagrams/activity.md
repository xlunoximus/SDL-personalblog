...
1. [Создание поста](#1)
2. [Просмотр постов](#2)
3. [Просмотр деталей поста](#3)

### 1. Создание поста<a name="1"></a>

![Создание поста](https://github.com/xlunoximus/SDL-personalblog/blob/main/diagrams/png/Activity_create_post.png)

### 2. Просмотр постов<a name="2"></a>
